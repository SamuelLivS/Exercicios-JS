...
const juroSimples = (capInicial, tJuros, tempoAp) => { 
    ...
    const rendimentoMes = capInicial * juros
...
const juroComposto = (capInicial, tJuros, tempoAp) => {
    ...
    let rendimentoMes = rendimentoFinal * juros
    

    while(i <= tempoAp){
        rendimentoFinal += rendimentoMes
        rendimentoMes = rendimentoFinal * juros
        i++
    }
...
console.log(juroSimples(100, 0.10, 2))
console.log(juroComposto(100, 0.20, 5))